(function(){
  ...
  const TEXT = {
    es: {
      ...
      finDesc: 'Sin desembolso inicial: pagas el equipo a plazos. Las condiciones de propiedad al final dependen del contrato de financiación.',
    ...
    en: {
      ...
      finDesc: 'No upfront payment: you pay for the equipment in instalments. Ownership conditions at the end depend on the financing contract.',
